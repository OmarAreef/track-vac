...
let dictAbout = {
    ...
    'ar': {
        'header': 'ما هو تراكڤاك؟',
        'description1': ' "تراكڤاك" هو موقع إلكتروني حيث تجد كل المعلومات المهمه عن كيفية تلقي اللقاح حولك' ,
        'description2':'"تراكڤاك" سيتيح لأفراد المجتمع المحلي تبادل ومشاركة تجاربهم في سبيل القضاء علي انتشار الوباء ',
